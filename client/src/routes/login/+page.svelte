	...
	<form on:submit|preventDefault={submit} class="m-auto drop-shadow-xl bg-white rounded py-2 px-5 text-slate-700">
		...
		<div class="my-5 w-min">
			<div class="my-2">
                ...
                <label for="password">
                    Password
                    <input bind:value={password} class="border-2 rounded-sm w-full px-1 my-2 h-9" type="password"/>
                </label>
			</div>
